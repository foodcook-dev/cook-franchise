...
export default function SignalHeader() {
  return (
    <div className='signal-header border-border/50 absolute left-3 top-0 z-50 flex items-center gap-4 rounded-3xl border bg-white px-6 py-4 shadow-xl backdrop-blur-xl transition-all duration-300 hover:shadow-2xl'>
